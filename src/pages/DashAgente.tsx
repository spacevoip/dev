        ...
        <Card className="p-6">
          ...
          {callsError ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-lg font-medium text-red-800 mb-1">Erro ao carregar chamadas</h3>
              <p className="text-sm text-red-600">Não foi possível carregar as chamadas ativas. Tente novamente.</p>
              <Button
                variant="outline"
                size="sm"
                onClick={() => refetch()}
                    ...
                    <tr>
                      <td colSpan={5} className="text-center py-12 text-gray-500">
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-1">
                            <p className="text-lg font-medium text-gray-600">Nenhuma chamada ativa</p>
                            <p className="text-sm text-gray-500">As chamadas ativas aparecerão aqui quando houver alguma em andamento</p>
                          </div>
                        </div>
                      </td>
                    </tr>
